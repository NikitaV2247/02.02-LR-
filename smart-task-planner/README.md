...
|---|---|---|
| Архитектор / Tech Lead | Абдуллаев И. А. | API-контракт, код-ревью, merge PR, разрешение конфликтов, скрипты интеграции | 
| Backend, Task Service | Орлов М. С., Баикин К. А.  | CRUD задач, SQLite-хранилище, очередь вебхуков с retry, тесты | 
| Backend, Notification Service | Васильев Н. С. | Приём вебхуков, уведомления, тесты | 
